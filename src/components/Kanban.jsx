  ...
  return (
    <div className="bg-gray-400 h-screen w-screen">
      <div className="form_layout">
        ...
        >
          <input className="border-2 border-black" onChange={(e)=>setNewTask(e.target.value)} value={newTask}></input>
      ...
      <div className="flex justify-center m-auto">
        {stages.map((stage,stageIndex)=>{
          return (
            <div className="justify-center border-2 h-[70vh] w-[20vw] m-3" key={stageIndex}>
              <h4 className="text-center font-bold text-lg underline underline-offset-4">{stage}</h4>
              <ul>
                  ...
                  <li key={taskIndex}>
                    <div className="flex justify-center">
                      ...
                      <span className="flex">
                        ...
                        <button onClick={()=>handleDelete(stageIndex,taskIndex)}>X</button>
                      </span>
                    </div>
                  </li>
                );
